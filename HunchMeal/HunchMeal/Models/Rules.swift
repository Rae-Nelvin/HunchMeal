...
struct RulesList {
    static let lists: [Rules] = [
        ...
        Rules(rules: "You can long press each of the cards to see the image more clearly"),
        Rules(rules: "You ay tap \("Ask Question") button to help you find the food you can ask questions to our bot and it will answer if the food compatible with what question you asked"),
